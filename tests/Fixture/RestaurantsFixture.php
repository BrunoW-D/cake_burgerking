...
class RestaurantsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'IDX_EB95123FA73F0036' => ['type' => 'index', 'columns' => ['town_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'FK_EB95123FA73F0036' => ['type' => 'foreign', 'columns' => ['town_id'], 'references' => ['towns', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
