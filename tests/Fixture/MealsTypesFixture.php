...
class MealsTypesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            ...
            'IDX_E7827A99EC666B44' => ['type' => 'index', 'columns' => ['type_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'FK_E7827A99CCD7E912' => ['type' => 'foreign', 'columns' => ['meal_id'], 'references' => ['meals', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'FK_E7827A99EC666B44' => ['type' => 'foreign', 'columns' => ['type_id'], 'references' => ['types', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
